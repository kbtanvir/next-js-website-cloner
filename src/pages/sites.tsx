      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {siteNavigation.map((project) => (
          <Link prefetch={false} key={project.id} href={project.path} passHref>
            <div
              className="group relative flex h-[300px] w-[400px] flex-col justify-end overflow-hidden rounded-2xl shadow-lg transition-transform duration-300 hover:-translate-y-2"
              style={{
